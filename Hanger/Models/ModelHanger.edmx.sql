...
-- --------------------------------------------------
-- Date Created: 02/25/2018 00:24:35
-- Generated from EDMX file: C:\Users\Krzysiek\Source\Repos\Hanger-mgr\Hanger\Models\ModelHanger.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd308596]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Favourite] DROP CONSTRAINT [FK_FKAd308596];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd464028]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ad] DROP CONSTRAINT [FK_FKAd464028];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd465758]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserProfil] DROP CONSTRAINT [FK_FKAd465758];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd475152]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ad] DROP CONSTRAINT [FK_FKAd475152];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd476875]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserProfil] DROP CONSTRAINT [FK_FKAd476875];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd478957]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserProfil] DROP CONSTRAINT [FK_FKAd478957];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd487456]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserProfil] DROP CONSTRAINT [FK_FKAd487456];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd497584]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserProfil] DROP CONSTRAINT [FK_FKAd497584];
GO
IF OBJECT_ID(N'[dbo].[FK_FKAd513542]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Favourite] DROP CONSTRAINT [FK_FKAd513542];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Favourite]', 'U') IS NOT NULL
...
-- Creating primary key on [Id] in table 'Favourite'
ALTER TABLE [dbo].[Favourite]
ADD CONSTRAINT [PK_Favourite]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO

-- Creating primary key on [Id] in table 'UserProfil'
...
-- Creating foreign key on [AdId] in table 'Favourite'
ALTER TABLE [dbo].[Favourite]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd308596'
CREATE INDEX [IX_FK_FKAd308596]
ON [dbo].[Favourite]
    ([AdId]);
GO

-- Creating foreign key on [UserId] in table 'Favourite'
ALTER TABLE [dbo].[Favourite]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd513542'
CREATE INDEX [IX_FK_FKAd513542]
ON [dbo].[Favourite]
    ([UserId]);
GO

-- Creating foreign key on [BrandId] in table 'UserProfil'
ALTER TABLE [dbo].[UserProfil]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd487456'
CREATE INDEX [IX_FK_FKAd487456]
ON [dbo].[UserProfil]
    ([BrandId]);
GO

-- Creating foreign key on [Color1Id] in table 'UserProfil'
ALTER TABLE [dbo].[UserProfil]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd476875'
CREATE INDEX [IX_FK_FKAd476875]
ON [dbo].[UserProfil]
    ([Color1Id]);
GO

-- Creating foreign key on [Color2Id] in table 'UserProfil'
ALTER TABLE [dbo].[UserProfil]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd478957'
CREATE INDEX [IX_FK_FKAd478957]
ON [dbo].[UserProfil]
    ([Color2Id]);
GO

-- Creating foreign key on [SizeId] in table 'UserProfil'
ALTER TABLE [dbo].[UserProfil]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd465758'
CREATE INDEX [IX_FK_FKAd465758]
ON [dbo].[UserProfil]
    ([SizeId]);
GO

-- Creating foreign key on [UserId] in table 'UserProfil'
ALTER TABLE [dbo].[UserProfil]
ADD CONSTRAINT [FK_FKAd497584]
    FOREIGN KEY ([UserId])
    REFERENCES [dbo].[User]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FKAd497584'
CREATE INDEX [IX_FK_FKAd497584]
ON [dbo].[UserProfil]
    ([UserId]);
GO
